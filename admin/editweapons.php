...
<?php
        $id=$_GET['id'];
        //echo $id;exit;
        $sql="Select * from gameplay Where id='".$_GET['id']."'";
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Edit Weapons</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Edit Weapons</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    ...
                                    <form class="form-horizontal" method="POST"  name="userform" enctype="multipart/form-data" action="updateweapons.php" id="form1" name="form1">

                                    <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">ID</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="id" id="id" readonly value='<?php echo $row['id'] ?>' class="form-control" required />
