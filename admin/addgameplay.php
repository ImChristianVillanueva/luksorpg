...
?>
  <!-- Page wrapper  -->
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Gameplay</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Add Gameplay</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
	...
	if(isset($_POST['sb']))
	{
		...
		include "../constant/connect.php";
		mysqli_query($con,"insert into gameplay(image,description)values('$i','$description')") or die(mysqli_error($con));
